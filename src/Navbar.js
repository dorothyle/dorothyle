      ...
      <div className={style.navbarContainer}>
        <div className={style.navbarIcons}>
          ...
          <div className={style.hamburger} onClick={toggleHamburger}>
            <img
              className={`${style.hamburgerLogo} ${
                hamburgerOpen ? style.disappear : ""
              }`}
              src={hamburgerMenu}
            />
            <img
              className={`${style.xLogo} ${hamburgerOpen ? style.appear : ""}`}
              src={xLogo}
            />
          </div>
        </div>
        ...
        <div className={style.navlinksContainer}>
          <ul
            className={`${style.navlinks} ${hamburgerOpen ? style.open : ""}`}
          >
            <li>About</li>
            <li>Projects</li>
            <li>Experience</li>
